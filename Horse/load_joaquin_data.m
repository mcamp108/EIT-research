...
function filesOut = files_for_horse(rootDir, horse)
    ...
    switch horse
        ...
        case 296695
            ...
            startIdx    = [1,1,1,1,1,1,1,1,1];
            endIdx      = [-1,-1,-1,-1,-1,-1,-1,-1,-1];
            perfStart   = [0, 0, 1000,...
                        1200, 0, 680,...
                        1200, 0, 0];
            perfEnd     = [0, 0, 2500,...
        ...
        case 296954
            ...
            startIdx    = [1,1,1,1,250,1,1,1,1]; 
            endIdx      = [7424,-1,-1,-1,-1,-1,-1,4100,-1];
            perfStart   = [0, 0, 0,1200, 0, 0,530, 900, 1400];
            perfEnd     = [0, 0, 0,250+2400, 0, 0,2500, 3200, 2900];
